        ...
        <div className="bg-gray-100 mt-12 px-4 md:px-12">
            ...
            <div className="flex items-center justify-center flex-wrap gap-6">
                {mainCategories && mainCategories.map(item => {
                    ...
                    return (
                        <div key={item._id} onClick={() => handleCategoryClick(item._id)} className="group bg-white p-3 md:p-4 rounded-xl shadow-md flex flex-col items-center gap-4 cursor-pointer">
                            <img src={fullImageUrl} alt={item.image.alt} loading="lazy" className="w-28 md:w-32 h-28 md:h-32 object-cover duration-500 rounded-lg group-hover:scale-110" />
