                        ...
                        return (
                            <div key={index} className='flex flex-col gap-3'>
                                ...
                                <div className='flex flex-col gap-3 mt-4'>
                                    ...
                                    <p className=' bg-gray-200 py-2 px-4 rounded-lg max-w-max mt-4'>
                                ...
                                <div className='flex items-center gap-3 mt-6'>
                                    ...
                                    <a href='https://wa.me/01011789966' target='_blanck' className="p-2 flex justify-center items-center rounded-full cursor-pointer duration-500 shadow-sm text-white bg-green-400 hover:scale-110 hover:shadow-md">
